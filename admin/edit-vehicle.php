...
<?php 
$fuel_type_array = array('Petrol','Diesel','CNG');
?>
<option value="">Please select a fuel type</option>
<?php 
foreach($fuel_type_array as $key=>$item)
{
?>
<option <?php if($item==$car_fuel_type) { echo "selected"; } ?> value="<?php echo $item; ?>"><?php echo $item; ?></option>
<?php 
}
?>
</select>
